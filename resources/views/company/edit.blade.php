...
@section('content')
<h1>Επεξεργασία Εταιρίας για πρακτική</h1>
		...
		<div class="row">
			<div class="col-md-3">
				<div class="form-group">
				  	...
				  	<select class="form-control select2" name="category_id">
					    ...
					    @foreach ($company_categories as $company_category)
					    	@if ($company_category->id == $company->category_id)
		        ...
		        <div class="form-group">
		            ...
		            <input class="form-control" name="place" value="{{ $company->place }}">
		        </div>
		        <div class="form-group">
		            <label>Υπεύθυνος </label>
		            <input class="form-control" name="contact_person" value="{{ $company->contact_person }}">
		        </div>
		        <div class="form-group">
		            <label>E-mail </label>
		        ...
		        <div class="form-group">
		            ...
		            <input class="form-control" name="phones" value="{{ $company->phones }}">
		        </div>
		        <div class="form-group">
		            <label>Fax </label>
		            <input class="form-control" name="fax" value="{{ $company->fax }}">
		        </div>	               
		        <div class="form-group">
		            <label>Σχόλια</label>
		            <textarea class="form-control" rows="7" name="comments">{{ $company->comments }}</textarea>
		        </div>
			</div>
		</div>
		<div class="row">
